...
var UserWhere = struct {
	...
	Score:          whereHelperint64{field: "\"users\".\"score\""},
}
...
var (
	userAllColumns            = []string{"id", "first_name", "last_name", "username", "mobile", "badges", "contributions", "status", "followers", "following", "role", "password", "created_at", "updated_at", "profile_photo_id", "score"}
	userColumnsWithoutDefault = []string{"first_name", "last_name", "username", "mobile", "password"}
	userColumnsWithDefault    = []string{"id", "badges", "contributions", "status", "followers", "following", "role", "created_at", "updated_at", "profile_photo_id", "score"}
...
func (o *User) UserDevices(mods ...qm.QueryMod) userDeviceQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"user_devices\".\"user_id\"=?", o.ID),
	)
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (userL) LoadUserDevices(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser any, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		...
		qm.WhereIn(`user_devices.user_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
