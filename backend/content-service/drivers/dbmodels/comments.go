...
var CommentTableColumns = struct {
	...
	ModerationStatus: "comments.moderation_status",
...
var CommentWhere = struct {
	...
	ModerationStatus: whereHelperstring{field: "\"comments\".\"moderation_status\""},
...
var (
	commentAllColumns            = []string{"id", "content", "upvote", "downvote", "user_id", "post_id", "is_answer", "comment_id", "created_at", "updated_at", "moderation_status", "deleted_at"}
	commentColumnsWithoutDefault = []string{"content", "user_id", "post_id"}
	commentColumnsWithDefault    = []string{"id", "upvote", "downvote", "is_answer", "comment_id", "created_at", "updated_at", "moderation_status", "deleted_at"}
