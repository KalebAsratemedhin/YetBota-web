    ...
    <div className="fixed bottom-0 left-0 md:left-64 right-0 px-8 lg:px-32 py-6 bg-white/80 dark:bg-[#0a0a0a]/80 backdrop-blur-xl border-t border-slate-200 dark:border-white/5">
      <div className="w-full flex items-center gap-4">
        <div className="relative flex-1 group">
          <input
            className="w-full bg-slate-100 dark:bg-[#1a1a1a] border-none rounded-2xl py-4 pl-6 pr-14 focus:ring-2 focus:ring-brand transition-all text-slate-900 dark:text-white placeholder:text-slate-400"
            placeholder="Type your answer..."
            type="text"
          />
          <button
            type="button"
            className="absolute right-4 top-1/2 -translate-y-1/2 p-2 text-slate-400 hover:text-brand transition-colors"
